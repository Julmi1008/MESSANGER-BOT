...
module.exports.handleEvent = async ({
	...
	var h = {
		body: `»Notice from Owner ─◉❖𝗝𝗨𝗟𝗠𝗜≛𝗝𝗔𝗔𝗧❖◉─ «\n\n${c}, You are stupid for cursing bots so bots automatically banned you from the system`
	};
    //Add curse words without capital letters
	["bot mc", "Mc bot", "Chutiya bot", "Bsdk bot", "Bot teri maa ki chut", "kuta bot", "Bot chutiya", "stupid bots", "Gandu bot", "Bot lund", "Bot gandu", "Mc julmi", "Bsdk julmi", "fuck bots", "Julmi chutiya", "Julmi gandu", "Bot bsdk", "Julmi bc", "Khtm bot", "bc Julmi", "Nikal bsdk bot", "Bot kuta", "Bot kmina", "kmina bot", "Jaar bot", "Bot jaar", "Bot TMKC", "TMKC BOT", "boT lol", "bot óc", "bot óc chó", "cc bot", "bot tiki", "lozz bottt", "lol bot", "loz bot", "lồn bot", "bot lồn", "bot lon", "bot cac", "bot nhu lon", "bot như cc", "bot như bìu", "Bot sida", "bot sida", "bot fake", "Bảo ngu", "bot shoppee", "bad bots", "bot cau"].forEach((a => {
